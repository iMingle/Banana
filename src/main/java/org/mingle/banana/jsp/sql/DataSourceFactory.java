package org.mingle.banana.jsp.sql;
...
/**
 * This class is an implementation of the ObjectFactory interface, used by a
 * container to create instances of resources accessible through JNDI. It's
 * intended to be used to create an instance of the DataSource class and
 * configure it as defined by the parameters passed through the JNDI
 * implementation.
 *
...
public class DataSourceFactory implements ObjectFactory {
	 ...
	 * The class name must be passed as a parameter named "dataSourceClassName".
	 * Introspection is used to find and call setter methods in the DataSource
	 * corresponding to all other parameters.
	 */
	...
	/**
	 * Sets the specified property to the specified value in the specified
	 * object.
	 */
	...
	/**
	 * Returns the setter method corresponding to the property name in the
	 * specified object, or null if no matching setter method is found.
	 */
	...
	/**
	 * Converts the specified String value to the setter methods parameter type,
	 * if possible, and returns it as an Object array suitable as the argument
	 * to the Method.invoke() method.
	 */
	...
	/**
	 * Converts the specified String value to the specified type, if possible,
	 * and returns the converted value.
	 *
	 * Only conversion to Integer and Boolean is currently supported, since
	 * these types covers all DataSource implementations I've come across. It's
	 * easy to add new conversions if needed.
	 */
