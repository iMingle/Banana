...
/**
 * This class implements a connection pool. It's the same as the ConnectionPool
 * class described in Java Servlet Programming (O'Reilly), Second Edition,
 * copied with permission from Jason Hunter. It's used by the DataSourceWrapper
 * class to provide a JDBC 2.0 DataSource interface to the pool.
 *
