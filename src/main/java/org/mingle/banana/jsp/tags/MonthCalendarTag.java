...
public class MonthCalendarTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		/*
		 * If padding is needed before the first of the month, evaluate the
		 * padding pattern for each day of the previous month in the first week.
		 */
		if (padPattern != null) {
		...
		/*
		 * If padding is needed after the last of the month, evaluate the
		 * padding pattern for each day of the next month in the last week.
		 */
		if (padPattern != null) {
