package org.mingle.banana.jsp.tlv;
...
/**
 * This is an example of a TagLibraryValidator class. It only validates the use
 * of the dummy &lt;xmp:child&gt; action element in a dummy tag library, but it
 * serves as an extendable validator for a real tag library.
 *
...
public class OraTLV extends TagLibraryValidator {
	...
	private Namespace jspNamespace = Namespace
			.getNamespace("http://java.sun.com/JSP/Page");
	...
	/**
	 * Dispatches to the appropriate validation method for the specified
	 * element, and calls itself recursively for all children of the element.
	 */
	...
	/**
	 * Validates that a "child" element is only used within the body of a
	 * "parent" element. If not, a ValidationMessage is added to the message
	 * array.
	 */
	...
	/**
	 * Returns the closest parent element of the specified element that matches
