...
/**
 * This class contains information about a user. It's used to show how a bean
 * can be used to capture and validate user input.
 *
...
public class UserInfoBean {
	...
	/**
	 * Returns true if all property values have valid values (they are only set
