...
/**
 * This class is a bean that can be used to extract debug information from a JSP
 * PageContext.
 *
...
public class DebugBean {
	...
	public Map<String, Object> getRequestInfo() {
		if (pageContext == null) {
			throw new IllegalStateException(
					"The pageContext property is not set");
		}
		...
		info.put("contentLength",
				new Integer(req.getContentLength()).toString());
	...
	/**
	 * Returns the String "null" if the value is null, otherwise the value
	 * itself.
	 */
	...
	/**
	 * Returns a String representation of the specified Object, in a format
