...
public class EmployeeRegistryBean implements Serializable {
	private static final long serialVersionUID = -7079785245568983585L;
    ...
    public EmployeeBean getEmployee(String userName) throws SQLException {
        ...
        Map<String, Object> empRow = null;
        Map<String, Object>[] projects = null;
        try {
	...
	private Map<String, Object> getSingleValueProps(String userName, Connection conn) 
        throws SQLException {
     ...
     */
    @SuppressWarnings("unchecked")
	private Map<String, Object>[] getProjects(String userName, Connection conn) 
        throws SQLException {
     ...
     */
    private String[] toProjectsArray(Map<String, Object>[] projectRows) {
        if (projectRows == null) {
            return new String[0];
        }
