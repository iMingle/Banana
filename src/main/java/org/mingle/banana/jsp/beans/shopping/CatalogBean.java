...
/**
 * This class represents a product catalog. It holds a list of products
 * available for sale.
 * <p>
 * This is just a demo so the product list is hardcoded, created at
 * instantiation. A real version would get the information from an external data
 * source.
 *
...
public class CatalogBean implements Serializable {
	private static final long serialVersionUID = 6234348449574052324L;

	private Map<String, ProductBean> catalog = new HashMap<String, ProductBean>();

	/**
	 * Constructor. Creates all ProductBean objects and adds them to the
	 * catalog.
	 */
	public CatalogBean() {
	 ...
	 */
	public Map<String, ProductBean> getProductsById() {
		return catalog;
	}
}
