...
/**
 * This class is a bean for executing SQL statements. It has three properties
 * that can be set: connection, sqlValue and values. The connection and sqlValue
 * properties must always be set before calling one of the execute methods. If
 * the values property is set, the sqlValue property must be an SQL statement
 * with question marks as placeholders for the value objects in the values
 * property.
 *
...
public class SQLCommandBean {
	 ...
	 * @exception SQLException
	 */
	private void setValues(PreparedStatement pstmt, List<Object> values)
			throws SQLException {
