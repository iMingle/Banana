...
public class MixedMessageBean implements Serializable {
	...
	private static final long serialVersionUID = -143043005865907310L;
	...
	/**
	 * Returns a new message from the selected category every time it's called,
	 * cycling through all available messages.
	 */
