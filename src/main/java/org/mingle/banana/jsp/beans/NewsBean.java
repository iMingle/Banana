...
/**
 * This class maintains a list of NewsItemBean objects. It's only intended as an
 * example. A real implementation would use a database to keep track of the
 * objects instead.
 *
...
public class NewsBean implements Serializable {
	private static final long serialVersionUID = -1962131565782492580L;

	private ArrayList<NewsItemBean> newsItems = new ArrayList<NewsItemBean>();
	...
	public NewsItemBean[] getNewsItems() {
		...
		synchronized (newsItems) {
			a = (NewsItemBean[]) newsItems.toArray(new NewsItemBean[newsItems
					.size()]);
		}
		return a;
	}
