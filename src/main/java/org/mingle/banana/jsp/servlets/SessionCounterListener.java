...
/**
 * This class manages a counter for the number of active sessions in an
 * application. The counter is made available to the rest of the application as
 * a servlet context attribute of type <code>int[]</code> with one element.
 *
...
public class SessionCounterListener implements HttpSessionListener {
	...
	/**
	 * Returns the counter held in the session scope, or a new counter if it
	 * doesn't exist.
	 */
