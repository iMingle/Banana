...
public class HelloMIME extends HttpServlet {
	private static final long serialVersionUID = -8256053204878014018L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("plain".equals(type)) {
			...
			greeting = "<html><body><h1>" + greeting + "</h1></body></html>";
		...
		if (majorType == TEXT_TYPE) {
			...
			InputStream is = application.getResourceAsStream("/images/ora.gif");
			copyStream(is, os);
		}
	}
