...
public class SpitterControllerTest {
	...
	//
	// <start
	// id="java_SpitterControllerTest_shouldPutSpittlesForSpitterIntoModel" />
	@Test
	public void shouldProduceSpittlesForSpitter() {
		...
		when(spitterService.getSpittlesForSpitter("habuma")).thenReturn(
				expectedSpittles);

		SpitterController controller = new SpitterController(spitterService);// <co
																				// id="co_createController"/>

		ExtendedModelMap model = new ExtendedModelMap();
		String view = controller.listSpittlesForSpitter("habuma", model); // <co
																			// id="co_callMethod"/>
